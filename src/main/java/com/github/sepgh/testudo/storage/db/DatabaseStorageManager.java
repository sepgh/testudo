...
public class DatabaseStorageManager {
    ...
    public DatabaseStorageManager(EngineConfig engineConfig, FileHandlerPool fileHandlerPool, RemovedObjectsTracer removedObjectsTracer) {
    ...
    public DatabaseStorageManager(EngineConfig engineConfig, FileHandlerPool fileHandlerPool) {
        this.engineConfig = engineConfig;
        this.fileHandlerPool = fileHandlerPool;
