...
public class NullableUniqueTreeIndexManager<K extends Comparable<K>, V extends Number & Comparable<V>> extends UniqueTreeIndexManagerDecorator<K,V> {
    ...
    public NullableUniqueTreeIndexManager(UniqueTreeIndexManager<K, V> uniqueTreeIndexManager, DatabaseStorageManager storageManager, IndexHeaderManager indexHeaderManager, IndexBinaryObjectFactory<V> vIndexBinaryObjectFactory) {
        super(uniqueTreeIndexManager);
        this.storageManager = storageManager;
        this.indexHeaderManager = indexHeaderManager;
        this.vIndexBinaryObjectFactory = vIndexBinaryObjectFactory;
    }
