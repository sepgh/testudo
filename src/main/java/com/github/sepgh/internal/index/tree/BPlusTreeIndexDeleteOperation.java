...
public class BPlusTreeIndexDeleteOperation<K extends Comparable<K>, V extends Comparable<V>> {
    ...
    public BPlusTreeIndexDeleteOperation(int degree, int table, IndexIOSession<K> indexIOSession, NodeInnerObj.Strategy<V> valueStrategy, NodeFactory<K> nodeFactory) {
        this.degree = degree;
        this.table = table;
